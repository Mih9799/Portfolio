...
[AddComponentMenu("AIE Scripts/Camera Fade/Camera Fade In")]
public class CameraFadeIn : MonoBehaviour {
	...
	//bool FadeIn = true;
	public bool DestroySelfAfterFadeIn = true;
	...
	{		
		...
		SetScreenOverlayColor(FadeColor);
	...
	void Update()
	{
		...
		else if(IsFading)
		{
			Ftimer += Time.deltaTime;
				...
				SetScreenOverlayColor(Color.Lerp(FadeColor,Color.clear,Ftimer/FadeTime));

			if(DestroySelfAfterFadeIn && Ftimer > FadeTime)
				{
					Destroy(this);
				}
